...
/*!
 * @file CrossingInfoPubSubTypes.h
...
#ifndef _FAST_DDS_GENERATED_CROSSINGINFO_PUBSUBTYPES_H_
#define _FAST_DDS_GENERATED_CROSSINGINFO_PUBSUBTYPES_H_
...
public:
    ...
    typedef CrossingInfoType type;

    eProsima_user_DllExport CrossingInfoTypePubSubType();

    eProsima_user_DllExport virtual ~CrossingInfoTypePubSubType() override;
